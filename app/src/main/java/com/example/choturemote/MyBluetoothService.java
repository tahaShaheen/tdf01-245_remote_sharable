...
public abstract class MyBluetoothService {
    ...
    /**
     * @brief boolean status of mConnectedThread
     * @details For use in other Activities that create an object of type MyBluetoothService. Will prevent crashes if attempts to write to Bluetooth are made when the connected does not exist.
     */
    public static boolean mConnectedThreadRunning = false;
     ...
     * @brief Writes to the "face device"
     * @details
    ...
    /**
     * @return boolean status of mConnectedThread
     * @brief returns boolean status of mConnectedThread
     * @details For use in other Activities that create an object of type MyBluetoothService. Will prevent crashes if attempts to write to Bluetooth are made when the connected does not exist.
     */
    public static boolean connectedThreadRunning() {
        return mConnectedThreadRunning;
    }
